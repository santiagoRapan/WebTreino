...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex h-9 w-9 items-center justify-center border-y border-r text-sm shadow-sm transition-all outline-none",
        "bg-background/50 dark:bg-background/80 border-border/60 dark:border-border/40",
        "first:rounded-l-md first:border-l last:rounded-r-md",
        "data-[active=true]:z-10 data-[active=true]:border-ring data-[active=true]:ring-ring/20 data-[active=true]:ring-2",

  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "flex w-fit items-center justify-between gap-2 rounded-md border-2 px-3 py-2 text-sm whitespace-nowrap shadow-sm transition-all outline-none cursor-pointer",

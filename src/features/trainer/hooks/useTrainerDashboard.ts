...
import { useRoutineState } from '@/features/routines'
import { createClientHandlers } from '../services/clientHandlers'
import { createRoutineHandlers } from '@/features/routines/services/routineHandlers'
import { Users, Dumbbell, UserPlus } from 'lucide-react'
import type { DashboardStat, RecentClient } from '../types'
